 ...
 */
export function addBlockToParent(blocks: NestedContentBlock[], parentId: string, newBlock: NestedContentBlock): NestedContentBlock[] {
 ...
 */
export function updateBlockById(blocks: NestedContentBlock[], blockId: string, updates: Partial<NestedContentBlock>): NestedContentBlock[] {
    return blocks.map((block) => {
        if (block.id === blockId) {
            // Update this block
 ...
 */
export function deleteBlockById(blocks: NestedContentBlock[], blockId: string): NestedContentBlock[] {
    return blocks
 ...
 */
export function duplicateBlock(blocks: NestedContentBlock[], blockId: string): { blocks: NestedContentBlock[]; newBlockId: string } {
...
function createDuplicate(block: NestedContentBlock): NestedContentBlock {
    ...
    const duplicatedBlock: NestedContentBlock = {
        ...block,
        id: newId,
        children: block.children ? block.children.map((child: NestedContentBlock) => createDuplicate(child)) : undefined,
    };

...
export const CONTENT_VALIDATION_RULES: ValidationRule[] = [
    ...
    {
        parent: 'container',
        allowedChildren: ['text', 'image', 'button', 'spacer', 'social', 'video', 'audio'],
        maxChildren: 10,
    ...
    {
        parent: 'grid',
        allowedChildren: ['text', 'image', 'button', 'ecommerce', 'team', 'testimonial'],
        maxChildren: 12,
    ...
    {
        parent: 'tabs',
        allowedChildren: ['text', 'image', 'video', 'chart', 'form', 'code'],
        minChildren: 1,
        maxChildren: 8,
    ...
    {
        parent: 'accordion',
        allowedChildren: ['text', 'image', 'video', 'form'],
        minChildren: 1,
        maxChildren: 10,
